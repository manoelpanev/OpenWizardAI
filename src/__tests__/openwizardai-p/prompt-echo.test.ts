 ...
 * @description Tests for src/openwizardai-p/prompt-echo.ts - the check that the
 * prompt claude logged is the prompt openwizardai-p typed into its TUI.
 */
...
import {
	...
	promptEchoText,
} from '../../openwizardai-p/prompt-echo';
