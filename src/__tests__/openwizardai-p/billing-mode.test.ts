 ...
 * @description Tests for src/openwizardai-p/billing-mode.ts - reading claude's
 * billing mode off the TUI startup header and explaining it.
 */

import { describe, expect, it } from 'vitest';

import { diagnoseApiUsageBilling, showsApiUsageBilling } from '../../openwizardai-p/billing-mode';
...
describe('diagnoseApiUsageBilling', () => {
	...
	// The desktop scans openwizardai-p stderr with Claude's error bank, so a reason
