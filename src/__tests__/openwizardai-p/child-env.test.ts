 ...
 * @description Tests for src/openwizardai-p/child-env.ts - the environment openwizardai-p
...
import { buildChildEnv, CLAUDE_SESSION_IDENTITY_ENV_VARS } from '../../openwizardai-p/child-env';
...
describe('buildChildEnv', () => {
	it('strips every Claude session identity marker and keeps auth and config', () => {
		...
		expect(env.OPENWIZARDAI_CLAUDE_BIN).toBe('/bin/claude');
	});
