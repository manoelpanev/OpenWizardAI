 ...
 * @description Tests for src/openwizardai-p/jsonl-tailer.ts - the poll-based
...
} from '../../openwizardai-p/jsonl-tailer';
...
describe('JsonlTailer', () => {
	...
	beforeEach(() => {
		tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'openwizardai-p-tailer-'));
		activeTailer = null;
	});
