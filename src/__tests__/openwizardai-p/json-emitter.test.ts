 ...
 * @description Tests for src/openwizardai-p/json-emitter.ts - the stream-json
...
import {
	...
	type StatusSnapshot,
} from '../../openwizardai-p/json-emitter';
...
describe('JsonEmitter', () => {
	...
	describe('writeLine EPIPE handling', () => {
		it('swallows EPIPE when the stdout reader has gone (no crash)', () => {
			...
			// emitInit emits through writeLine; a dead pipe must not crash openwizardai-p.
