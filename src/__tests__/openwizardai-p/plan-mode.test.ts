 ...
 * @description Tests for src/openwizardai-p/plan-mode.ts ExitPlanMode detection.
 *
 ...
 * TUI parks on an approval dialog openwizardai-p can't answer), and its plan body is
...
import { extractExitPlanText } from '../../openwizardai-p/plan-mode';
