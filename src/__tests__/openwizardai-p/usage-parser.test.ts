 ...
 * @description Tests for src/openwizardai-p/usage-parser.ts - parses Claude's
...
import { parseUsage, RESET_SPEC_BODY } from '../../openwizardai-p/usage-parser';
import type { StatusSnapshot } from '../../openwizardai-p/json-emitter';

const FIXTURES_DIR = path.join(__dirname, '..', 'fixtures', 'openwizardai-p-usage');
...
describe('parseUsage / fixtures', () => {
	...
	// ANSI-stripped stderr openwizardai-p emitted while running --status
