/**
 * Input and TextArea components for OpenWizardAI web interface
 *
...
/**
 * Input component for the OpenWizardAI web interface
 *
 * @example
 * ```tsx
 * // Basic input
...
/**
 * TextArea component for the OpenWizardAI web interface
 *
 * @example
 * ```tsx
 * // Basic textarea
