...
import { getOpenInLabel, isLinuxPlatform, isMacOSPlatform } from '../../../utils/platformUtils';
					...
					<div data-setting-id="general-display-sleep">
						...
						>
							<div className="flex-1 pr-3">
								...
								<div className="text-xs opacity-50 mt-0.5" style={{ color: theme.colors.textDim }}>
									Also blocks the screen saver, the screen lock, and idle logout, so a long run
									stays on screen and you stay signed in
								</div>
							</div>
							<ToggleSwitch
						...
						{isMacOSPlatform() && preventSleepEnabled && preventDisplaySleepEnabled && (
							...
							>
								...
								XProtect scans, Time Machine thinning, and background updates. In exchange the
								session stays active: no screen saver, no lock screen, no idle logout.
							</div>
						)}
					</div>
