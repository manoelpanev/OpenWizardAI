...
interface OpenWizardAIWizardProps {
	theme: Theme;
...
/**
 * OpenWizardAIWizard - Main wizard orchestrator component
 *
 ...
 */
export function OpenWizardAIWizard({
	theme,
	onLaunchSession,
	onWizardStart,
	onWizardResume,
	onWizardAbandon,
	onWizardComplete,
}: OpenWizardAIWizardProps): JSX.Element | null {
	const {
		state,
		closeWizard,
		saveStateForResume,
