/**
 * OpenWizardAIFlags - Texas + American flag pair marking OpenWizardAI's origin.
 *
 ...
 * saloon where OpenWizardAI was born.
 */

import { openInSystemBrowser } from '../../utils/openUrl';

export interface OpenWizardAIFlagsProps {
...
export function OpenWizardAIFlags({ width = 40, opacity = 0.7 }: OpenWizardAIFlagsProps) {
