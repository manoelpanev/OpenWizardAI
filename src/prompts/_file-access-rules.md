<!--
Directory write restrictions for OpenWizardAI-managed agents and the Auto Run folder carve-out. Include this where the agent needs to understand or explain its write boundaries.
-->
