...
function generateReadme(): string {
	return `# OpenWizardAI Debug Package

This package was generated by OpenWizardAI for debugging purposes.
...
1. Open a GitHub issue at https://github.com/manoelpanev/OpenWizardAI/issues
...
export async function createZipPackage(
	...
	const filename = `openwizardai-debug-${timestamp}.zip`;
