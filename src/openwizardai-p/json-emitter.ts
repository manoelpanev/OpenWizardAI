// Stream-json emitter for openwizardai-p.
//
// Serializes the four-event protocol OpenWizardAI's existing claude-output-parser
// already understands:
//
...
// our source of truth (see OPENWIZARDAI-P-01-binary.md "Architectural Lessons #1");
...
export class JsonEmitter {
	...
	private writeLine(obj: unknown): void {
		try {
			...
			// nothing left to emit to, so swallow it instead of crashing openwizardai-p
