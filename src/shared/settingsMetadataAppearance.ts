...
export const APPEARANCE_SETTINGS_METADATA: Record<string, SettingMetadata> = {
	...
	updatesPromptSeen: {
		description:
			'Whether the first-run step covering release candidate updates, crash reporting, and the OpenWizardAI CLI install has been shown.',
		type: 'boolean',
		default: false,
		category: 'appearance',
	},
	agentPowersPromptSeen: {
		description: 'Whether the "your agents can drive OpenWizardAI" first-run step has been shown.',
		type: 'boolean',
		default: false,
		category: 'appearance',
	},
	...
	showLeftPanelCueIndicator: {
		description:
			'Show the OpenWizardAI Cue activity indicator (lightning bolt) next to agents with active Cue subscriptions in the left side bar. Hidden when the OpenWizardAI Cue Encore Feature is disabled.',
		type: 'boolean',
		default: true,
		category: 'appearance',
	},
