...
description: Browse, preview, and import community playbooks from the OpenWizardAI Playbook Exchange.
icon: store
---
...
Playbooks are fetched from the [OpenWizardAI-Playbooks](https://github.com/manoelpanev/OpenWizardAI-Playbooks) GitHub repository. The manifest is cached locally for 6 hours to minimize API calls.
...
2. **Directly on GitHub** - Submit a pull request to the [OpenWizardAI-Playbooks repository](https://github.com/manoelpanev/OpenWizardAI-Playbooks)
